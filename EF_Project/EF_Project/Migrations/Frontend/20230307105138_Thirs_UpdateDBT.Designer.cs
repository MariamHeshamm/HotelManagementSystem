...
namespace EF_Project.Migrations.Frontend
{
    ...
    [Migration("20230307105138_Thirs_UpdateDBT")]
    partial class Thirs_UpdateDBT
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_Project.Entities.Room", b =>
                {
                    b.HasOne("EF_Project.Entities.RoomFloor", null)
                        .WithMany("Rooms")
                        .HasForeignKey("RoomFloorId");

                    b.HasOne("EF_Project.Entities.RoomType", null)
                        .WithMany("Rooms")
